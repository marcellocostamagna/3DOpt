...
"""
plot_RndSam.py
Plot grouped Random Sampler 3DOpt scores with consistent styles and layout.

Usage:
    python plot_RndSam.py [csv1.csv csv2.csv ...]
    (defaults to hardcoded file list)
"""
